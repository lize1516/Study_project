...
public class Html2 {
    ...
    //获取省 、市 、县等的信息
    public List<String> getProvince(String name,String url ,String type)
    {
        List<String> result = new ArrayList<>();
        int index = url.lastIndexOf("/");
        String urlPublic = url.substring(0,index);
                ...
                if(e!=null){
                    ...
                    for(Element ec : e.children())  //一个tr的子元素td，td内包含a标签
                    {
                        ...
                        if(ec.children().first()!=null)
                        {
                             ...
                             */
                            // attr() 获取属性的值
                            prv[2]= urlPublic + "/"+ ec.children().first().attr("href");  //北京的url

                            System.out.println("url2 = " + prv[2]);
